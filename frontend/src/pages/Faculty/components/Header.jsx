...
const mockNotifications = [
  { id: 1, text: 'Book return due tomorrow.', time: '2 hours ago', unread: true },
  { id: 2, text: 'Your reservation for "Advanced Robotics" is ready.', time: '1 day ago', unread: false },
  ...
  return (
    <header className="app-header">
      ...
      <div className="header-controls">
        ...
        {/* User Avatar */}
        <div className="header-user" onClick={() => navigate('/faculty/profile')} style={{ cursor: 'pointer' }}>
