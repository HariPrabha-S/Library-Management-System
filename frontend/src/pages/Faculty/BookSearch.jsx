...
const BookSearch = ({ user }) => {
  ...
  const fetchBooks = () => {
    ...
    // fetch(`http://localhost:5001/api/books/search?${params}`)
    //   .then(r => r.json())
    ...
    setTimeout(() => {
      let mockBooks = [
        { id: 101, title: 'Artificial Intelligence', author: 'Stuart Russell', isbn: '978-0134610993', category: 'AI / ML', available: true, library: 'Main', location: 'AI Lab Reference', callNumber: 'Q335.R86' },
        { id: 102, title: 'Deep Learning', author: 'Ian Goodfellow', isbn: '978-0262035613', category: 'Computer Science', available: false, library: 'Main', location: 'Section A, Shelf 3', callNumber: 'QA76.9' },
        { id: 103, title: 'Modern Operating Systems', author: 'Andrew S. Tanenbaum', isbn: '978-0133591620', category: 'Software Eng.', available: true, library: 'Department', location: 'Section C, Shelf 2', callNumber: 'QA76.76.O63' },
      ];
