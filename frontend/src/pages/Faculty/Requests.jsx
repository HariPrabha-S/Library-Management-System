...
const Requests = ({ user }) => {
  ...
  useEffect(() => {
    ...
    const dummyRequests = [
      { id: 1, bookName: 'Advanced Robotics', library: 'Main', requestDate: '2025-03-22', status: 'Pending' },
      { id: 2, bookName: 'Pattern Recognition', library: 'Main', requestDate: '2025-03-10', status: 'Approved' },
    ];
